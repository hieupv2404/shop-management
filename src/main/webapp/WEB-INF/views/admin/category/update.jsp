            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Category</h3>
                        <p class="text-subtitle text-muted">Category update</p>
                    </div>
...
<%--                    </div>--%>
                    <div class="card-body">
                        <c:url value="/admin/categories/updateCategoryPost" var="urlPost"></c:url>
                        <form:form action="${urlPost}" modelAttribute="categoryUpdate">
...
<%--                                            <form:errors path="name" cssClass="error" cssStyle="color: red"/>--%>
                                    ...
                                    <div class="form-group">
                                        <td colspan="2"><input type="submit" class="btn btn-success" value="Update">
                                        </td>
                                    </div>
                                </div>
                            </div>
