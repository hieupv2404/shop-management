                                            ...
                                            <ul class="users-list-wrapper media-list">
                                                <li class="media mail-read">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="mail-message" id="greetings">
                                                ...
                                                <li class="media mail-read">
                                                    ...
                                                    <div class="pr-50">
                                                        <div class="avatar">
                                                            <img class="rounded-circle" src="/static/assets/images/faces/3.jpg"
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="pr-50">
                                                        <div class="avatar">
                                                            <img class="rounded-circle" src="/static/assets/images/faces/7.jpg"
                                                                 alt="Generic placeholder image">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="pr-50">
                                                        <div class="avatar">
                                                            <img class="rounded-circle" src="/static/assets/images/faces/5.jpg"
                                                                 alt="Generic placeholder image">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                ...
                                                <li class="media mail-read">
                                                    ...
                                                    <div class="pr-50">
                                                        <div class="avatar">
                                                            <img class="rounded-circle" src="/static/assets/images/faces/8.jpg"
                                                                 alt="Generic placeholder image">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                ...
                                                <li class="media mail-read">
                                                    ...
                                                    <div class="pr-50">
                                                        <div class="avatar">
                                                            <img class="rounded-circle" src="/static/assets/images/faces/6.jpg"
                                                                 alt="Generic placeholder image">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="pr-50">
                                                        <div class="avatar">
                                                            <img class="rounded-circle" src="/static/assets/images/faces/1.jpg"
                                                                 alt="Generic placeholder image">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                            ...
                                                            <div class="collapse-title media">
                                                                <div class="pr-1">
                                                                    <div class="avatar mr-75">
                                                                        <img src="/static/assets/images/faces/18.jpg"
                                                    ...
                                                    <div class="card collapse-header" role="tablist">
                                                        <div id="headingCollapse6"
                                                            ...
                                                            <div class="collapse-title media">
                                                                <div class="pr-1">
                                                                    <div class="avatar mr-75">
                                                                        <img src="/static/assets/images/faces/19.jpg"
                                                                             alt="avtar img holder" width="30" height="30">
                                                                    </div>
                                                                </div>
                                                                <div class="media-body mt-25">
...
<script type="text/javascript">
    ...
    function showGreeting(message) {
        $("#greetings").append("<p class='list-group-item-text truncate mb-0'>"
            + message +
        "</p>");
    }
